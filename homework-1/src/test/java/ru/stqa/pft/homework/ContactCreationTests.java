...
public class ContactCreationTests {
    ...
    private void fillContactCreation() {
        ...
        wd.findElement(By.name("lastname")).sendKeys("Shaikin");
        ...
        wd.findElement(By.name("home")).sendKeys("+79876391174");
        wd.findElement(By.name("email")).click();
        wd.findElement(By.name("email")).clear();
        wd.findElement(By.name("email")).sendKeys("shaikins@yahoo.com");
    }
